...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Premium Plots & Land for Sale in Ahmedabad | TC Real Estates",
      },
      {
    ...
    links: [{ rel: "canonical", href: "https://tcrealestate.lovable.app/" }],
    scripts: [
      {
    ...
    <div className="min-h-screen bg-background text-foreground">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-2.5 text-[15px]">
                {[
                  ...
                  "Clear titles & secure properties",
                  "Close to industries & prime locations",
                ].map((t) => (
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  to="/properties"
                  className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-3 rounded-md text-sm font-bold tracking-wide hover:opacity-90"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-brand-dark text-white px-5 py-3 rounded-md text-sm font-bold tracking-wide hover:opacity-90"
                >
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-xs tracking-[0.25em] text-muted-foreground font-semibold">
            WHY INVEST IN AHMEDABAD?
          </p>
          <h2 className="mt-3 text-3xl md:text-4xl font-extrabold">
            A City. Unlimited Opportunities.
          </h2>
      ...
      <section className="pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-center text-2xl font-extrabold tracking-wide mb-8">
            FEATURED PLOTS IN AHMEDABAD
          </h2>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <Link
                    to="/properties/$id"
                    params={{ id: p.id }}
                    className="mt-4 block text-center border border-border rounded-md py-2 text-xs font-bold tracking-wide hover:bg-primary hover:text-primary-foreground hover:border-primary transition"
                  >
                    ENQUIRE NOW
                  </Link>
                </div>
          ...
          <div className="mt-10 text-center">
            <Link
              to="/properties"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-md text-xs font-bold tracking-widest hover:opacity-90"
            >
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-center text-sm tracking-[0.25em] font-bold mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                q: "Great opportunities and genuine guidance. Highly professional team!",
                n: "Hardik Shah",
                r: "Business Owner",
              },
              {
                q: "Very good knowledge of locations and future growth. Got the best deal!",
                n: "Vijay Parmar",
                r: "Industrial Buyer",
              },
            ].map((t) => (
      ...
      <section className="max-w-7xl mx-auto px-6 pb-12">
        <div className="bg-primary text-primary-foreground rounded-lg px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-white text-primary px-5 py-3 rounded-md text-xs font-bold tracking-widest hover:bg-white/90"
          >
