      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {items.map((p) => (
            ...
            >
              {p.cover_image && (
                <img src={p.cover_image} alt="" className="w-20 h-20 rounded object-cover" />
              )}
              ...
              <div className="flex gap-1">
                <button onClick={() => setEditing(p)} className="p-2 hover:bg-muted rounded">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={12}
              className="w-full mt-1 border border-border rounded-md px-3 py-2 text-sm font-mono bg-background"
            />
          </div>
          <div>
            ...
            <div className="mt-1 flex items-center gap-3">
              {f.cover_image && (
                <img src={f.cover_image} alt="" className="w-24 h-16 object-cover rounded" />
              )}
              <label className="inline-flex items-center gap-2 border border-dashed border-border rounded-md px-3 py-2 text-sm cursor-pointer hover:bg-muted">
                ...
                <input
                  type="file"
                  accept="image/*"
                  onChange={(e) => upload(e, "cover_image")}
                  className="hidden"
                />
              </label>
            </div>
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-3">
              {f.og_image && (
                <img src={f.og_image} alt="" className="w-24 h-16 object-cover rounded" />
              )}
              <label className="inline-flex items-center gap-2 border border-dashed border-border rounded-md px-3 py-2 text-sm cursor-pointer hover:bg-muted">
                {uploading ? (
                  <Loader2 className="w-4 h-4 animate-spin" />
